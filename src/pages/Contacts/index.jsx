            ...
            <div className="page-container">
                <div className="contact__container">
                        ...
                        <div className="contact__cards">
                            ...
                            <div className="contact__card contact__card--smm">
                                ...
                                <div className="contact__card-smm">
                                    <ul className="contact-smm">
                                        <li className="contact-smm__item">
                                            <a href="/" className="contact-smm__link">
                    ...
                    <div className="contact__map">
                        <iframe title="capital-invest-map" width="520" height="400" frameBorder="0" scrolling="no"
